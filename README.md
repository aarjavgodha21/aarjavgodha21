...
<picture>
  <source media="(prefers-color-scheme: dark)" srcset="https://raw.githubusercontent.com/aarjavgodha21/aarjavgodha21/output/github-contribution-grid-snake-dark.svg">
  <img
    alt="GitSnake — contribution animation"
    src="https://raw.githubusercontent.com/aarjavgodha21/aarjavgodha21/output/github-contribution-grid-snake.svg"
    style="max-width:100%; border-radius:12px; box-shadow: 0 8px 30px rgba(0,0,0,0.55); display:block; margin:12px 0;"
  />
</picture>
